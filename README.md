...
A lightweight Python utility for retrieving <u>and fixing</u> SonarQube/SonarCloud code quality violations (bugs, vulnerabilities, code smells) from any branch.
